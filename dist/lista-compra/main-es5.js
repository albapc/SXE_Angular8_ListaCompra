...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _servicio_de_autent_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./servicio-de-autent.service */
    "./src/app/servicio-de-autent.service.ts");
    /* harmony import */


    var _fire_db_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./fire-db.service */
    "./src/app/fire-db.service.ts");

    var AppComponent = function AppComponent(authComponent, dbApp) {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _lista_productos_lista_productos_component__WEBPACK_IMPORTED_MODULE_5__["ListaProductosComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"], _angular_fire__WEBPACK_IMPORTED_MODULE_7__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"].firebaseConfig), _angular_fire_auth__WEBPACK_IMPORTED_MODULE_8__["AngularFireAuthModule"], _angular_fire_database__WEBPACK_IMPORTED_MODULE_9__["AngularFireDatabaseModule"]],
      providers: [],
  ...
  function srcAppFireDbServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    FireDBService.ctorParameters = function () {
      return [{
        type: _angular_fire_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"]
      }];
    };

    FireDBService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], FireDBService);
    /***/
  },
  ...
  function srcAppListaProductosListaProductosComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(ListaProductosComponent, [{
        key: "seleccionarCompra",
        value: function seleccionarCompra(index) {
          // EN VARIAS LINEAS
  ...
  /***/
  function srcAppServicioDeAutentServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ServicioDeAutentService", function () {
      return ServicioDeAutentService;
    });
    /* harmony import */
    ...
    var ServicioDeAutentService =
    /*#__PURE__*/
    function () {
      function ServicioDeAutentService(miAuth) {
        _classCallCheck(this, ServicioDeAutentService);

        this.miAuth = miAuth; // email = '';
        // pass = '';
        // el usuario ya autenticado

        this.authUser = null; // observable

        this.user = this.miAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (authState) {
      ...
      _createClass(ServicioDeAutentService, [{
        key: "login",
        value: function login() {
          var _this = this;

          console.log('Github login!');
          this.miAuth.auth.signInWithPopup(new firebase__WEBPACK_IMPORTED_MODULE_4__["auth"].GithubAuthProvider()).then(function (user) {
        ...
        value: function glogin() {
          ...
          this.miAuth.auth.signInWithPopup(new firebase__WEBPACK_IMPORTED_MODULE_4__["auth"].GoogleAuthProvider()).then(function (user) {
            console.log('user logado: ', user); // this.email = '';
            // this.pass = '';
    ...
    ServicioDeAutentService.ctorParameters = function () {
      return [{
        type: _angular_fire_auth__WEBPACK_IMPORTED_MODULE_2__["AngularFireAuth"]
      }];
    };

    ServicioDeAutentService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Alba\Desktop\SXE_Angular8_ListaCompra\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
